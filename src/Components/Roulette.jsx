...
export default function Roulette() {
    ...
    const colors = ["green", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "green", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black", "red", "black"]
    ...
    return (
        <div id="rbody">
            ...
            <div class="Roulette">
            <Wheel mustStartSpinning={mustSpin} prizeNumber={prizeIndex} data={possibilities} backgroundColors={colors} textColors={["white"]} onStopSpinning={() => setMustSpin(false)} fontSize={20} perpendicularText={true} textDistance={90}/>
            {spinValue < 37 ? (
                <>{spinValue}       {winners}</>
            ) : (
                <></>
